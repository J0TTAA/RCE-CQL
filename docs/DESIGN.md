...
- El editor clinico no expone JSON libre. Los alumnos agregan, editan o eliminan
  recursos del sandbox mediante formularios controlados por catalogo: condiciones,
  observaciones, medicamentos, alergias, encuentros, procedimientos,
  inmunizaciones y ordenes clinicas.
...
- Los recursos clinicos generados por el sandbox usan IDs estables derivados de
  la fila editable y se insertan primero en el bundle efectivo para que la ficha
  muestre inmediatamente el escenario creado.
